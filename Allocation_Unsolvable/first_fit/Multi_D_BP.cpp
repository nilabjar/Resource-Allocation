...
Multi_D_BP::Multi_D_BP (int range_max, float slack, int upper_bound, string expt_name, int count)
  : success (0),
  failure(0),
  trials (0),
  size_exceeded (0),
...
void Multi_D_BP::print_filled_bins_char (ofstream& out,
										 int run_num,
										 string heur)
{
	out << run_num
...
void Multi_D_BP::generate_items_unsolvable (int bins)
{
	int size;
	Item_Type item;
